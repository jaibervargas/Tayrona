...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{  asset('iconos/logo-tayrona.png') }}">
    <link rel="icon" type="image/png" href="{{  asset('iconos/logo-tayrona.png') }}">
